...
// ─── SlugEditor — MUST be outside SettingsPage ────────────────────────────────
      ...
      {editing && (
        <div>
          ...
          <div style={{
            ...
            Update your printed materials and social media bio after changing.
          </div>
      ...
      {activeTab === "branding" && (
        <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
          <div style={{
            ...
            <div style={{
              height: 140,
              background: form.coverImage ? `url(${form.coverImage}) center/cover` : "linear-gradient(135deg, #1a0a2e, #0a1a2e)",
              position: "relative",
              display: "flex",
              alignItems: "flex-end",
              padding: "0 20px 16px",
              ...
              <div style={{
                ...
                fontSize: 32, flexShrink: 0, marginRight: 14, overflow: "hidden",
              }}>
                {!form.logo && "🍽️"}
              </div>
              <div>
            ...
            <div style={{ padding: "12px 16px", display: "flex", gap: 8 }}>
              <div style={{ padding: "8px 16px", background: form.accentColor, borderRadius: 20, fontSize: 12, fontWeight: 700, color: "#000" }}>
                Order Now 💬
              </div>
              <div style={{ padding: "8px 16px", background: form.accentColor + "20", border: `1px solid ${form.accentColor}40`, borderRadius: 20, fontSize: 12, fontWeight: 700, color: form.accentColor }}>
                View Cart
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div style={{ display: "flex", gap: 16, alignItems: "flex-start" }}>
              ...
              <div style={{ flex: 1, fontSize: 12, color: "rgba(255,255,255,.35)", lineHeight: 1.7, paddingTop: 8 }}>
                Your logo appears on the menu page, QR code, and all customer-facing pages.
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div style={{ display: "flex", gap: 10, alignItems: "center", flexWrap: "wrap" }}>
              {["#25D366", "#FF6B35", "#E63946", "#D4A853", "#06B6D4", "#8B5CF6", "#EC4899", "#10B981"].map((color) => (
                <button key={color} onClick={() => setForm(p => ({ ...p, accentColor: color }))} style={{
      ...
      {activeTab === "profile" && (
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          <div style={{
            ...
            <button onClick={() => setForm(p => ({ ...p, isOpen: !p.isOpen }))} style={{
              padding: "10px 20px",
          ...
          <div>
            <label style={{ fontSize: 13, fontWeight: 600, color: "rgba(255,255,255,.6)", display: "block", marginBottom: 6 }}>Restaurant Name (English)</label>
            <input style={inp} value={form.name} onChange={e => setForm(p => ({ ...p, name: e.target.value }))} placeholder="Asian Taste" />
          </div>
